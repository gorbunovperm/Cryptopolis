...
contract Cryptopolis {
    ...
    constructor() public {
        ...
        fields[1] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 1, price: 100});
        fields[2] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 1, price: 110});
        fields[3] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 1, price: 120});
        fields[4] = Field({payment: 100, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_FEE, group: 0, price: 0});
        fields[5] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 2, price: 110});
        fields[6] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 2, price: 120});
        fields[7] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 2, price: 130});
        ...
        fields[10] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 3, price: 130});
        fields[11] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 3, price: 140});
        fields[12] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 3, price: 150});
        ...
        fields[17] = Field({payment: -2, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 4, price: 140});
        fields[18] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 4, price: 150});
        fields[19] = Field({payment: -3, owner: EMPTY_OWNER, level: 2, fieldType: FIELD_COMPANY, group: 4, price: 160});
        ...
        fields[22] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 5, price: 160});
        fields[23] = Field({payment: -3, owner: EMPTY_OWNER, level: 1, fieldType: FIELD_COMPANY, group: 5, price: 170});
        fields[24] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 5, price: 180});
        fields[25] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 6, price: 170});
        fields[26] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 6, price: 180});
        fields[27] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 6, price: 190});
        ...
        fields[30] = Field({payment: -3, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 7, price: 190});
        fields[31] = Field({payment: -4, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 7, price: 200});
        fields[32] = Field({payment: -4, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 7, price: 210});
        ...
        fields[35] = Field({payment: -4, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 8, price: 200});
        fields[36] = Field({payment: -4, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 8, price: 210});
        fields[37] = Field({payment: -4, owner: EMPTY_OWNER, level: 0, fieldType: FIELD_COMPANY, group: 8, price: 220});
